...
#         description="Extract roof footprints (polygon) + height from a roof PLY file and write JSON."
#     )
#     parser.add_argument("--ply", required=True, help="Path to input roof .ply file")
...
#     if isinstance(geom, trimesh.Scene):
#         # Some PLYs may load as Scene; merge into one mesh
#         geom = trimesh.util.concatenate(tuple(geom.dump()))
...
#         building_id = f"element_{idx:03d}"
#         rec = component_to_building_record(
#             comp,
#             building_id=building_id,
